...
public class VpnProfileControlActivity extends AppCompatActivity {
    ...
    public static final String FORCE_DISCONNECT = "org.strongswan.android.action.FORCE_DISCONNECT";
    ...
    private void handleIntent() {
        ...
        if (START_PROFILE.equals(intent.getAction())) {
            ...
            disconnect(intent);
        } else if (FORCE_DISCONNECT.equals(intent.getAction())) {
            forceDisconnect();
        }
    }
    ...
    public static class ConfirmationDialog extends AppCompatDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            DialogInterface.OnClickListener connectListener = (dialog, which) -> {
                VpnProfileControlActivity activity = (VpnProfileControlActivity) getActivity();
                activity.startVpnProfile(profileInfo);
            };
            DialogInterface.OnClickListener disconnectListener = (dialog, which) -> {
                VpnProfileControlActivity activity = (VpnProfileControlActivity) getActivity();
            ...
            DialogInterface.OnClickListener cancelListener = (dialog, which) -> getActivity().finish();
